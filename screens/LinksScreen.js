...
import { ScrollView, StyleSheet, Text, View, TouchableWithoutFeedback, Animated, Image, Dimensions, SafeAreaView } from 'react-native';
...
var images = [
  {id: 1, src: require('../assets/images/people/Shaun.jpg')},
  {id: 2, src: require('../assets/images/people/Alexander.jpg')},
  {id: 3, src: require('../assets/images/people/Bo.jpg')},
]
      ...
      <SafeAreaView style={{ flex: 1}}>
        ...
        pointerEvents={this.state.activeImage ? "auto" : "none"}> 
          ...
          <Animated.View style = {[{ flex: 1, zIndex:1000, backgroundColor: 'white', padding: 20, paddingTop: 50}, animatedContentStyle]}>
            <Text style = {{fontSize: 24, paddingBottom: 10, fontWeight: 'bold'}}> Shaun Howe </Text>
            <Text style = {{fontSize: 18, padding: 5}}>Shaun is a second year PhD student who heads the SENSE project under the supervision of Dr. Ning Zeng. More information about Shaun can be found at atmos.umd.edu/~showe/.</Text>
          </Animated.View>
        </View>
      </SafeAreaView>
    );
